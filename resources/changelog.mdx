...
- Added **historical user positions** with `GET /alpha/historical-positions/{userAddress}`, returning vaults a user held during a selected time window. This helps integrators reconstruct previous user exposure, not just current balances.
