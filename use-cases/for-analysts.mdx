...
description: "Query standardized APY, TVL, the Reputation Score, and benchmark rates across 1,000+ vaults. No blockchain parsing — clean, normalized data via REST API."
...
Most yield analysis starts with data cleanup: protocols report APY differently, rewards are often separated from base yield, and historical TVL or share-price data is not always easy to compare. Vaults.fyi normalizes the market into one queryable dataset.

Use Vaults.fyi to:

- Compare base APY, reward APY, and total APY across 1 hour, 1 day, 7 day, and 30 day windows.
- Pull historical APY, TVL, and benchmark data without running your own indexers.
- Screen vaults by reputation score, active warnings, curator, protocol, asset, network, capacity, or TVL.
- Build dashboards, research notes, and allocator reports from a consistent data model.
...
<Info>
  Need more API access or higher rate limits? [Sign up](https://portal.vaults.fyi/signup) for Pay-As-You-Go access with no commitments. For custom metrics or specific vault coverage, [submit interest](https://vaultsfyi.fillout.com/t/tLA9t6HyAFus) and the team will follow up.
</Info>
