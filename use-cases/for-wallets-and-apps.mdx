...
Vaults.fyi gives wallets, exchanges, neobanks, fintech apps, portfolio tools, and aggregators the building blocks for embedded earn and borrow experiences across 80\+ protocols and 20\+ chains. Use normalized vault and market data as the foundation, then add transaction payloads, portfolio tracking, borrowing views, attribution, or fee logic as your product evolves.
...
<CardGroup cols={2}>
  ...
  <Card title="Data-only yield views" icon="table" href="/api-reference/endpoint/get-detailed-vaults">
