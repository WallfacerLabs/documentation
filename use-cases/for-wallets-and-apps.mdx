...
<Steps>
  ...
  <Step title="Optional: add borrowing views">
    Use the borrowing API to show supported borrow markets, supplied and borrowed positions, risk metrics, and available supply, withdraw, borrow, or repay actions. Borrowing is currently an early-access surface moving toward Beta, so check the API Reference for the current endpoint namespace.
  </Step>
</Steps>
