...
description: "Learn how Vaults.fyi Reputation Scores work, what five dimensions they measure, how flag penalties apply, and how to use minVaultScore to filter vaults programmatically."
...
The `penaltyComponents` field in [detailed-vaults](/api-reference/detailed-vaults) responses shows each active or decaying flag penalty, its severity, and resolution status.
