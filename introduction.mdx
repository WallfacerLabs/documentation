...
<CardGroup cols={2}>
  ...
  <Card title="Core Concepts" icon="book-open" href="/concepts/market-data">
...
<Steps>
  <Step title="Get an API key">
    [Contact us](https://vaultsfyi.fillout.com/t/tLA9t6HyAFus) to request access. You'll receive an API key to authenticate all requests.
  </Step>
...
Vaults.fyi powers yield analytics, dashboards, and transaction flows for [Jumper](https://jumper.exchange/), [Kraken Wallet](https://www.kraken.com/wallet), [Etherscan](https://etherscan.io/), [Gauntlet](https://gauntlet.network/), [Maple Finance](https://maple.finance/), and more. See the [case studies](/resources/case-studies) for integration details.
