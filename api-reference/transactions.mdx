...
| Check balances and limits before building a fixed-term transaction | [`GET /beta/fixed-term/context/{userAddress}/{network}/{vaultId}`](/api-reference/beta#fixed-term-pendle) | Beta |
