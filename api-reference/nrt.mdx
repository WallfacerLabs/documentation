...
## Related Beta endpoints

Borrow market live data is currently exposed through the Beta borrow market surface.

| Capability | How to call | Status |
|------------|-------------|--------|
| Fetch near-real-time borrow market asset data | [`GET /beta/borrow/markets/nrt/{network}/{marketId}/{assetId}`](/api-reference/beta#borrow-markets) | Beta |
