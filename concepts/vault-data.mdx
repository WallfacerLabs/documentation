...
| Field | Description |
| --- | --- |
| `score.vaultScore` | Composite score combining all sub-scores, after any flag penalties are applied. |
...
Use `flags` to surface active protocol notices in your UI, such as paused deposits, ongoing audits, or deprecation notices. Active flags also reduce the vault's Reputation Score — see [Flag penalties](/methodology/reputation-scores#flag-penalties) for how severity and decay work.
