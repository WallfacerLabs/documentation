...
description: "Find, filter, and understand DeFi vaults using normalized identity, performance, TVL, fee, risk, holder, and transaction support data."
sidebarTitle: "Vault Discovery"
---
...
Vaults.fyi computes a composite reputation score for each vault based on several risk signals. Higher is better. See [Reputation Score](/methodology/reputation-score) for methodology.
...
Active flags can reduce the vault's Reputation Score. Resolved flags may still appear and may still contribute a reduced penalty while the Reputation Score recovers — see [Flag penalties](/methodology/reputation-score#flag-penalties) for how severity and decay work.
...
See [Transaction Flows](/concepts/transaction-flows) for full details on building deposit and withdrawal flows.
