...
If you want attribution, discovery, positions, and transaction-ready flows packaged into one branded surface, see the [embeddable widget](/use-cases/embeddable-widget).
