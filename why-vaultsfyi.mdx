...
<CardGroup cols={3}>
  ...
  <Card title="Use the widget" icon="window" href="/use-cases/embeddable-widget">
    Add a branded Earn experience with curated discovery, positions, and transaction-ready flows.
  </Card>
</CardGroup>
